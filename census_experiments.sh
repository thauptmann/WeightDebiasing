...
python src/run_weighting_experiment.py --dataset census --method adaDebias --bias none
...
python src/run_weighting_experiment.py --dataset census --method adaDebias --bias oversampling
...
python src/run_weighting_experiment.py --dataset census --method adaDebias --bias undersampling
